      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          <form
            ...
            className="bg-white rounded-site border border-gray-100 shadow-sm p-5 sm:p-6 space-y-4 h-full"
          >
          ...
          {officeAddress && (
            <div className="bg-white rounded-site border border-gray-100 shadow-sm p-5 sm:p-6 flex flex-col h-full">
              ...
              <div className="relative flex-1 min-h-[280px] rounded-site overflow-hidden border border-gray-200">
                <iframe
