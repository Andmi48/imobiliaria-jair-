...
/** Banner de erro de publicação — o estado de rascunho fica no AdminPublishBar. */
export default function AdminSyncBanner() {
  const { lastSyncStatus, lastSyncError, publishChanges, isCloudConfigured, isLoadingFromCloud, isReady } =
    useSiteContent()
  ...
  if (lastSyncStatus !== 'error') return null
